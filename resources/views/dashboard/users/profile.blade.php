    ...
    <div class="container-fluid" style="padding: 20px;">
            ...
            <div class="row">
                    ...
                    <div>
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum, aperiam? Ea rem sit minus fugiat soluta</p>
                    </div>
                    </div>
                    <div class="col-sm-12 col-md-8">
                    <div class="card pb-5">
                        <div class="card-body">
                            {!! Form::open(['method'=>'PUT','route'=>['user-profile-information.update', $user]]) !!}
