                ...
                <div class="col-sm-12 col-md-12">
                    <div class="card pb-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                {!! Form::select('role_id', $roles, $user->roles->first()->id, ['class' => 'form-control' . ($errors->has('role_id') ? ' is-invalid' : '')]) !!}
                            ...
                            <div class="form-group">
                                {!! Form::select('is_suspended', ['0' => 'Activa', '1' => 'Suspensa'], $user->is_suspended, ['class' => 'form-control' . ($errors->has('is_suspended') ? ' is-invalid' : '')]) !!}
                            ...
                            <div class="form-group">
                                {!! Form::textarea('description', $user->description, ['class' => 'form-control' . ($errors->has('description') ? ' is-invalid' : ''), 'rows'=>3]) !!}
