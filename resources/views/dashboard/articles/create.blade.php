...
<div class="row">
                    ...
                    {!! Form::open(['method'=>'POST','route'=>['articles.store'], 'files'=>true]) !!}
					<div class="row">

						<div class="col-sm-12 col-md-8">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Novo Artigo</h3>
								</div>
								<div class="card-body">
										...
										<div class="form-group">
										{!! Form::textarea('content', null, [ 'class' => 'text-area form-control ' . ( $errors->has('content') ? ' is-invalid' : '' )]) !!}
										...
										<div class="form-group">
										{!! Form::textarea('summary', null, ['rows'=>'3', 'class' => 'text-area form-control ' . ( $errors->has('summary') ? ' is-invalid' : '' )]) !!}
